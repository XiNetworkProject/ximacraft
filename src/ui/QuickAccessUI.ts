export class QuickAccessUI {
  ...
  constructor(
    ...
    buttons[1].addEventListener("click", callbacks.openInventory);
    buttons[2].addEventListener("click", callbacks.openCommands);
    buttons[3].addEventListener("click", callbacks.openCommandTable);
    buttons[4].addEventListener("click", callbacks.cycleQuality);
    buttons[5].addEventListener("click", () => callbacks.changeRenderDistance(-1));
    buttons[6].addEventListener("click", () => callbacks.changeRenderDistance(1));
