...
const blocks: BlockDefinition[] = [
  ...
  shapedBlock(BlockId.DIRT_PATH, "dirt_path", "Dirt Path", "dirt", "path", 0x7a6248, { collisionHeight: 1, hardness: 0.4 }),
  shapedBlock(BlockId.GRAVEL_PATH, "gravel_path", "Gravel Path", "gravel", "path", 0x77746e, { collisionHeight: 1, hardness: 0.5 }),
  shapedBlock(BlockId.COBBLESTONE_PATH, "cobblestone_path", "Cobblestone Path", "cobblestone", "path", 0x74777a, { collisionHeight: 1, hardness: 1.2 }),
