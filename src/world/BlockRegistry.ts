...
const blocks: BlockDefinition[] = [
  ...
  { id: BlockId.MUD, key: "mud", displayName: "Mud", texture: "mud", solid: true, hardness: 0.45, color: 0x4a3328 },
  {
  ...
  {
    id: BlockId.WEATHERED_PLANKS,
    key: "weathered_planks",
    displayName: "Weathered Planks",
    texture: "weathered_planks",
    solid: true,
    hardness: 1.4,
    color: 0x6f604d,
  },
  {
    id: BlockId.WEATHERED_BEAM,
    key: "weathered_beam",
    displayName: "Weathered Beam",
    textures: { top: "weathered_beam_top", bottom: "weathered_beam_top", side: "weathered_beam" },
    solid: true,
    hardness: 1.8,
    color: 0x4c3b2c,
  },
  {
    id: BlockId.WEATHERED_BEAM_X,
    key: "weathered_beam_x",
    displayName: "Weathered Beam",
    textures: { east: "weathered_beam_top", west: "weathered_beam_top", side: "weathered_beam" },
    solid: true,
    hardness: 1.8,
    color: 0x4c3b2c,
    creativeHidden: true,
  ...
  {
    id: BlockId.WEATHERED_BEAM_Z,
    key: "weathered_beam_z",
    displayName: "Weathered Beam",
    textures: { north: "weathered_beam_top", south: "weathered_beam_top", side: "weathered_beam" },
    solid: true,
    hardness: 1.8,
    color: 0x4c3b2c,
    creativeHidden: true,
